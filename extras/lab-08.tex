...
\begin{enumerate}
\item Download the list of variables for the 2018 American Community Survey, and find the variable \texttt{B19058\_002} - what is its description?\sidenote{\textit{Hint:} Hover your mouse over the field if some of the text is obscured, and the full text will appear as a ``tooltip''.}
